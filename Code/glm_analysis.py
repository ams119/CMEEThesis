...
dat = pd.read_csv("~/Documents/Hefty_Data/Extracted_Data/Aggregated/Lee _biweekly.csv")
#from glm_batch import dat
...
# FIX_ME This needs to be adjusted for each temporal scale
