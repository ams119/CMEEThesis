...
def fit_glm(dat, scale):
    ...
    precipday_lags = ['precipdays_lag0', 'precipdays_lag1', 'precipdays_lag2', 
        'precipdays_lag3', 'precipdays_lag4', 'precipdays_lag5']

    precipmean_lags = ['precipmean_lag0', 'precipmean_lag1', 'precipmean_lag2', 
        'precipmean_lag3', 'precipmean_lag4', 'precipmean_lag5']
